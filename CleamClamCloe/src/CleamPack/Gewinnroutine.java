		...
		time.scheduleAtFixedRate(new TimerTask() {
			...
			public void run() {
				...
				if (GUI.gewinner == 0) {
					...
					if (GUI.state[0] == 2 && GUI.state[1] == 1 && GUI.state[2] == 1) {
						GUI.gewinner = 2;
					}
					// Reihe 2 für O Horizontal
					if (GUI.state[3] == 2 && GUI.state[4] == 1 && GUI.state[5] == 1) {
						GUI.gewinner = 2;
					}
					// Reihe 3 für O Horizontal
					if (GUI.state[6] == 2 && GUI.state[7] == 1 && GUI.state[8] == 1) {
						GUI.gewinner = 2;
					}

					// Reihe 1 für O Vertikal
					if (GUI.state[0] == 2 && GUI.state[3] == 1 && GUI.state[6] == 1) {
						GUI.gewinner = 2;
					}
					// Reihe 2 für O Vertikal
					if (GUI.state[1] == 2 && GUI.state[4] == 1 && GUI.state[7] == 1) {
						GUI.gewinner = 2;
					}
					// Reihe 3 für O Vertikal
					if (GUI.state[2] == 2 && GUI.state[5] == 1 && GUI.state[8] == 1) {
						GUI.gewinner = 2;
					}
					// Diagonal links oben nach rechts unten für O
					if (GUI.state[0] == 2 && GUI.state[4] == 1 && GUI.state[8] == 1) {
						GUI.gewinner = 2;
					}
					// Diagonal rechts oben nach links unten für O
					if (GUI.state[2] == 2 && GUI.state[4] == 1 && GUI.state[6] == 1) {
						GUI.gewinner = 2;
					}
				}
			}
